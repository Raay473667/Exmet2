...
def plot(x01, x02, p0, bounds, y_plot):
    ...
    ax.plot(x, first_gaussian(x, params[0], params[1], params[3]), label="K$_{α1}$ Gaussian")
    ax.plot(x, second_gaussian(x, params[2], params[1], params[4]), label="K$_{α2}$ Gaussian")
